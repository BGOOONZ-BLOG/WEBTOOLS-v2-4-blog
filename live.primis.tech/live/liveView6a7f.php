				...
				var SekindoClientDynamicConfig = function (config, prob)
{
	...
	this.deviceTypeSetup = function(rules)
	{
		...
		if (selectedRule[3] != 'undefined' && selectedRule[3].length > 0)
		{
			...
			if (floatSetup[0] === 1)
			{
				if (ref.config.videoType != 'sticky')
				{
...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=102618&cbuster=%%CACHEBUSTER%%&pubUrl=%%REFERRER_URL_ESC%%&subId=[SUBID_ENCODED]&x=%%WIDTH%%&y=%%HEIGHT%%&vp_content=plembed130eurgxmtsq&cbuster=1653242248',
					origQString: 's=102618&cbuster=%%CACHEBUSTER%%&pubUrl=%%REFERRER_URL_ESC%%&subId=[SUBID_ENCODED]&x=%%WIDTH%%&y=%%HEIGHT%%&vp_content=plembed130eurgxmtsq',
					placementId: 102618,
					x: 400,
					y: 225,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"","browser":"","browserType":"","browserVersion":"","browserVersionMajor":"","browserVersionMinor":"","chromeVersion":""},"browser":"other","os":"other","osVer":"","deviceType":"other","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'US',
					dmaCode: 501,
					dynamicSetup: [],
